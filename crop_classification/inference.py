...
class Inference:
    ...
    def _tif_to_np(
        ...
        # TODO: This is close to Engineer().process_test_file()
        # but does not rely on the Engineer class being initialized with labels
        # might make sense to add a majority of this class to cropharvest directly
    ...
    def run(
        ...
        x_np, flat_lat, flat_lon = self._tif_to_np(
